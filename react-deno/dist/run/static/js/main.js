...
var parseString = (token, isVariant)=>{
    let buffer = "";
    for(let __char, dynamic = false, position2 = 0; __char = token[position2++];){
        if (dynamic || __char == "[") {
            buffer += __char;
            dynamic = __char != "]";
            continue;
        ...
        switch(__char){
            case ":":
                buffer = buffer && startGrouping(":" + (token[position2] == __char ? token[position2++] : "") + buffer);
                break;
            case "(":
...
function App() {
    ...
    return react.createElement(react.Fragment, null, loading && react.createElement(Loading, null), !loading && react.createElement("div", {
        className: tw`px-2 py-8 w-full mx-auto`
...
const AlbumCard = ({ album , key  })=>{
    return react.createElement("div", {
        ...
        className: tw`w-full overflow-hidden px-2 pb-2`
    }, react.createElement("p", {
        className: tw`font-bold truncate`
    }, album.title), react.createElement("p", null, album.artist), react.createElement("p", null, album.year)));
};
const AlbumList = ({ albums  })=>{
    return react.createElement("div", {
        className: tw`flex flex-wrap gap-2 justify-center`
    }, albums.map((album)=>react.createElement(AlbumCard, {
            key: album.id,
            album: album
        })));
};
